...
from ros_awsiot_agent import message_conversion as c
...
class TestMessageConversion(unittest.TestCase):
    ...
    def test_int_primitives(self):
        ...
        for msg in range(-100, 100):
            for rostype in ["int8", "int16", "int32", "int64"]:
                self.assertEqual(
                    c._to_primitive_inst(
                        msg, rostype, rostype, []), msg)
    ...
    def test_duration_msg(self):
        ...
        msg = {"durations": [
            {"sec": 3, "nanosec": 5}, {"sec": 2, "nanosec": 7}]}
    ...
    def test_unexpected_key_in_dict1(self):
        ...
        inst = ros_loader.get_message_instance(rostype)
        inst.cells = [ros_loader.get_message_instance(
            "geometry_msgs/Point") for i in range(100)]
    ...
    def test_unexpected_key_in_list_in_dict(self):
        ...
        inst = ros_loader.get_message_instance(rostype)
        inst.markers = [ros_loader.get_message_instance(
            "visualization_msgs/InteractiveMarker") for i in range(100)]
        inst.poses = [ros_loader.get_message_instance(
            "visualization_msgs/InteractiveMarkerPose") for i in range(100)]
