...
class Mqtt2Ros():
    def __init__(self, topic_from: str, topic_to: str, topic_type: str, conn_params: mqtt.ConnectionParams) -> None:
        ...
        self.mqtt_sub = pubsub.Subscriber(self.mqtt_connection, topic_from, callback=self.callback)
...
def main():
    ...
    conn_params.client_id = rospy.get_param('~client_id', default="mqtt-" + str(uuid4()))
